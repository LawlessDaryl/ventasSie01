                ...
                <div class="m-2">
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                          ...
                          <a class="nav-link active show" wire:click="$set('toogle', '1')" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab">Editar Servicio</a>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade {{$active2}}" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <div class="row mt-3">
                              ...
                              @if ($this->id_servicio != null and count($solicitudservicio)>0)
                              <div class="table-repuesto mr-3 ml-3">
                                <table>
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                             ...
                                             @foreach ($solicitudservicio as $l)
                            ...
                            <div class="row justify-content-center">
                                <div class="col">
                                    ...
                                    <p>No tiene repuestos asignados para este servicio</p>
                                </div>
