            ...
            <div class="widget-content">
                <div class="row">
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <select wire:model="userid" class="form-control">
                                <option value="0" dasabled>Elegir</option>
                                @foreach ($users as $u)
                    ...
                    <div class="col-sm-12 col-md-3 align-self-center d-flex justify-content-around">
                        @if ($u->id > 0 && $fromDate != null && $toDate != null)
                            <button class="btn btn-dark" wire:click.prevent="Consultar()"
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-sm-12 col-md-8">
                        <div class="table-responsive">
                            <table class="table table-boredered table-striped mt-1">
                                ...
                                <tbody>
                                    @if ($total <= 0)
                                        <tr>
                                            <td colspan="5">
                                                <h6 class="text-center">No hay ventas</h6>
                                            </td>
                                        </tr>
                                    @endif
