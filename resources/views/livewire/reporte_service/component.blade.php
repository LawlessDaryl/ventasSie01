            ...
            <div class="widget-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2 mt-4">                                
                                ...
                                <a class="btn btn-dark btn-block {{count($data) < 1 ? 'disabled' : ''}}" href="{{ url('reporteServicio/pdf' . '/' . $userId . '/' . $estado . '/' . $reportType . '/' 
                                    . $dateFrom . '/' . $dateTo)}}" style='font-size:18px'>Generar PDF</a>
                            ...
                            <table class="table table-unbordered table-hover mt-1">
                                ...
                                <tbody>
                                    @if(count($data) < 1) <tr>
                                        ...
                                        @foreach ($data as $d)
                                        <tr>
                                            {{-- $service->movservices[0]->movs->climov->client->nombre --}}
                                            <td class="text-center"><h6>{{$d->movservices[0]->movs->climov->client->nombre}}</h6></td>
                                            <td class="text-center"><h6>{{$d->order_service_id}}</h6></td>
                                            @foreach($d->movservices as $mv)
                                                @if($mv->movs->type=='PENDIENTE')
                                                <td class="text-center"><h6>{{$mv->movs->created_at}}</h6></td>
                                                    @if($mv->movs->status=='ACTIVO')
                                                    <td class="text-center"><h6>Pendiente</h6></td>
                                                    <td class="text-center"><h6>Pendiente</h6></td>
                                                    @endif
                                                @endif
                                                @if($mv->movs->type=='PROCESO')
                                                    ...
                                                    @if($mv->movs->status=='ACTIVO')
                                                    <td class="text-center"><h6>Proceso</h6></td>
                                                    <td class="text-center"><h6>Proceso</h6></td>
                                                    @endif
                                                @endif
                                                ...
                                                <td class="text-center"><h6>{{$mv->movs->created_at}}</h6></td>
                                                    ...
                                                    <td class="text-center"><h6>Terminado</h6></td>
                                                    @endif
                                                @endif
                                                ...
                                                @endif
                                            @endforeach
                                            <td class="text-center"><h6>{{number_format($d->costo,2)}}</h6></td>
                                            <td class="text-center"><h6>{{number_format($d->movservices[0]->movs->import,2)}}</h6></td>
                                            <td class="text-center"><h6>{{number_format($d->movservices[0]->movs->on_account,2)}}</h6></td>
                                            <td class="text-center"><h6>{{number_format($d->movservices[0]->movs->saldo,2)}}</h6></td>
                                            
                                            <td class="text-center"><h6>{{$d->OrderServicio->type_service}}</h6></td>
                                            <td class="text-center"><h6>{{$d->marca}} {{$d->categoria->nombre}}</h6></td>
                                            @foreach($d->movservices as $mv)
                                            @if($mv->movs->type=='PENDIENTE' && $mv->movs->status=='ACTIVO')
                                            <td class="text-center"><h6>{{$mv->movs->type}}</h6></td>
                                            <td class="text-center"><h6>{{$mv->movs->usermov->name}}</h6></td>
                                                ...
                                                <td class="text-center"><h6>{{$mv->movs->usermov->name}}</h6></td>
                                                    ...
                                                    <td class="text-center"><h6>{{$mv->movs->usermov->name}}</h6></td>
                                                        ...
                                                        <td class="text-center"><h6>{{$mv->movs->type}}</h6></td>
                                                        <td class="text-center"><h6>{{$d->movservices[2]->movs->usermov->name}}</h6></td>
