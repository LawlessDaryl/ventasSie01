                ...
                @foreach ($notificacion as $noti)
                        ...
                        <div class="items">
                            <div class="item-content">
                                <div class="user-profile">
                                    ...
                                    <img src="assets/img/moverinventario.jpg" alt="avatar">
                                ...
                                <div class="user-location">
                                    ...
                                    <p class="usr-location" data-location="Boston, USA">{{$noti->m}}</p>
                                </div>
                                <div class="user-phone">
                        ...
                        <div class="items">
                            <div class="item-content">
                                ...
                                <div class="user-location">
                                    <p class="info-title">Location: </p>
                                    <p class="usr-location" data-location="Boston, USA">{{$noti->nn}}</p>
                                </div>
                                <div class="user-phone">
                                    <p class="info-title">Phone: </p>
                                    <p class="usr-ph-no" data-phone="+1 (070) 123-4567">+1 (070) 123-4567</p>
