                    ...
                    <div class="card card-login card-hidden mb-3">
                            ...
                            <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email"
                                        class="form-control @error('email') es-invalido @enderror"
                                        placeholder="Correo@correo.com" required autocomplete="email" autofocus>
                                </div>
                        ...
                        <div class="card-footer justify-content-center">
                            <button type="submit" class="btn btn-primary btn-link btn-lg"
                                style="color: #ff7600">Ingresar</button>
                        </div>
                    </div>
                </form>
                <div class="row">
