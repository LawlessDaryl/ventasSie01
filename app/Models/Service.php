...
class Service extends Model
{
    ...
    protected $fillable = ['detalle','marca','falla_segun_cliente','diagnostico','solucion','costo','detalle_costo','fecha_estimada_entrega','cliente_id','cat_prod_service_id','order_service_id','type_work_id'];
